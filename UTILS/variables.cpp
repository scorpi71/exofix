...
namespace SETTINGS
{
	...
	{
		std::string file_path = "C:\\FlyingWare configs\\" + file_name + ".cfg";
	...
	{
		CreateDirectory("C:\\FlyingWare configs", NULL);
	...
	{
		std::string file_path = "C:\FlyingWare configs\\BlankConfig.cfg";
	...
	std::vector<std::string> CSettings::GetConfigs()
	{
		...
		WIN32_FIND_DATA ffd;
		auto directory = "C:\\FlyingWare configs\\*";
